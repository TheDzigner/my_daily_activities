 ...
 for (var i = 0; i < AllTodoTextes.length; i++) {
     ...
     if (checkMatches == AllTodoTextes[i].getAttribute('data-change')) {
      ...
      AllTodoTextes[i].classList.remove('editable')
       ...
       if (Todo_array[saveTodo.indexOf(this)].todo === AllTodoTextes[i].innerHTML.trim()) {
    ...
    radioBtn.addEventListener('click',function(e){
     ...
     e.stopImmediatePropagation()
      ...
      Todo_completed.push({
        ...
        date_completed : `${days[day]}, ${months[month]} ${day_number} -${year} at ${hours}:${minutes} ${isAm ? 'am' : 'pm'}`
  ...
  for (var i = 0; i < Todo_completed.length; i++) {
    ...
    <div class="left_side">
     ...
     <div class="data_wrapper">
      ...
      ${Todo_completed[i].date} / 

     Completed - ${Todo_completed[i].date_completed}
